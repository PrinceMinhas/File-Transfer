...
GOLDENDIR=/Users/PrinceMinhas/Documents/A3-self-test
USER=`whoami`
...
# Clone repo
git clone https://markus.teach.cs.toronto.edu/git/csc369-2018-01/group_0456/  "$TESTDIR"
...
for algo in rand; do
	...
	for trace in 1_trace 4_trace; do
		./sim -f $trace -m 8 -s 12 -a $algo | tail -n 7 > $trace.out
